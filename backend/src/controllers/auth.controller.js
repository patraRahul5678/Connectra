...
export async function signup(req, res) {
    ...
    try {
        ...
        const idx = Math.floor(Math.random() * 100) + 1; //generate random number between 1 to 100    
        const randomAvator = `https://api.dicebear.com/9.x/adventurer-neutral/png?seed=${idx}&size=128`
        ...
        try {
            ...
            console.error(`Error creating streamUser ${newUser.fullName}`, error);
        }
